...
public interface Belt {
	...
	/* this method makes belt impl observable by delivering
	 * plate event objects to registered observer by their  
	 handle plate event method when a plate is added*/
	void addBeltObserver(BeltObserver o);
	
	/* this method makes belt impl observable by delivering
	 * plate event objects to registered observer by their  
	 handle plate event method when a plate is removed*/
	void removeBeltObserver(BeltObserver o);
	
	//registers a customer at a set position
	public void registerCustomerAtPosition(Customer c, int position);
	
	//unregisteres a customer at a set position
