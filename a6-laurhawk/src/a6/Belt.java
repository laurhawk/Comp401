...
public interface Belt {
	...
	//overloads the iterator and iterator from position methods in your belt
	//interface and your implementation BeltImpl class so that it can be used to create
	//these new kinds of iterators for the belt
