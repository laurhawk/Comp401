...
public class A7AdeptTestSetA {
	...
	public void SetUp() throws PlatePriceException {
		...
		redPlateProfit = redPlate.getProfit();
		greenPlateProfit = greenPlate.getProfit();
		bluePlateProfit = bluePlate.getProfit();
		goldPlateProfit = goldPlate.getProfit();
	...
	@Test
	public void testPlateCounterWithExistingPlates() throws BeltPlateException {
		Belt b = new BeltImpl(10);
		b.setPlateAtPosition(redPlate, 0);
		b.setPlateAtPosition(redPlate, 1);
		b.setPlateAtPosition(redPlate, 2);
		b.setPlateAtPosition(redPlate, 3);
		b.setPlateAtPosition(redPlate, 4);
		b.setPlateAtPosition(redPlate, 5);
		b.setPlateAtPosition(greenPlate, 6);
		b.setPlateAtPosition(greenPlate, 7);
		b.setPlateAtPosition(greenPlate, 8);
		b.setPlateAtPosition(bluePlate, 9);
		
		PlateCounter plate_counter = new PlateCounter(b);
		assertEquals(6, plate_counter.getRedPlateCount());
		assertEquals(3, plate_counter.getGreenPlateCount());
		assertEquals(1, plate_counter.getBluePlateCount());
		assertEquals(0, plate_counter.getGoldPlateCount());
	}
	
	@Test
	public void testProfitCounterWithExistingPlates() throws BeltPlateException {
		Belt b = new BeltImpl(10);
		b.setPlateAtPosition(redPlate, 0);
		b.setPlateAtPosition(redPlate, 1);
		b.setPlateAtPosition(redPlate, 2);
		...
		ProfitCounter profit_counter = new ProfitCounter(b);
		assertEquals(6*redPlate.getProfit()+3*greenPlate.getProfit()+bluePlate.getProfit(), profit_counter.getTotalBeltProfit(), 0.005);
		assertEquals((6*redPlate.getProfit()+3*greenPlate.getProfit()+bluePlate.getProfit())/10.0, profit_counter.getAverageBeltProfit(), 0.005);
